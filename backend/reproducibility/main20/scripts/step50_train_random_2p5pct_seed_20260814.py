...
TRAIN_FILE = EXPERIMENT_ROOT / "37_ultra_low_budget_random_multiseed" / "seed_20260814" / "train_random_2p5pct.jsonl"
VALIDATION_FILE = DATASET_DIR / "validation.jsonl"
TEST_FILE = DATASET_DIR / "test.jsonl"

RUN_ROOT = EXPERIMENT_ROOT / "38_random_2p5pct_seed_20260814"
FULL_RUN_DIR = RUN_ROOT / "full_run"
SMOKE_RUN_DIR = RUN_ROOT / "smoke_test"

EXPECTED_TRAIN_SAMPLES = 400
EXPECTED_VALIDATION_SAMPLES = 1948
EXPECTED_TEST_SAMPLES = 2069
EXPECTED_TOTAL_SAMPLES = 4417
# =====================================================================
# Utility functions
# =====================================================================
...
def save_run_metadata(
    ...
    metadata = {
        "experiment": "tinyllama_qlora_main20k_random_2p5pct_seed_20260814",
