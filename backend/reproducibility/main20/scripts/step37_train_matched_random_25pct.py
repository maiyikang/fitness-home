...
TRAIN_FILE = EXPERIMENT_ROOT / "14_matched_random_baseline" / "train_matched_random_25pct.jsonl"
VALIDATION_FILE = DATASET_DIR / "validation.jsonl"
TEST_FILE = DATASET_DIR / "test.jsonl"

RUN_ROOT = EXPERIMENT_ROOT / "17_main20k_qlora_matched_random_25pct"
FULL_RUN_DIR = RUN_ROOT / "full_run"
SMOKE_RUN_DIR = RUN_ROOT / "smoke_test"

EXPECTED_TRAIN_SAMPLES = 3996
EXPECTED_VALIDATION_SAMPLES = 1948
EXPECTED_TEST_SAMPLES = 2069
EXPECTED_TOTAL_SAMPLES = 8013
...
def save_run_metadata(
    ...
    metadata = {
        "experiment": "tinyllama_qlora_main20k_matched_random_25pct",
