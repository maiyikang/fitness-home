...
TRAIN_FILE = EXPERIMENT_ROOT / "37_ultra_low_budget_random_multiseed" / "seed_20260815" / "train_random_1pct.jsonl"
VALIDATION_FILE = DATASET_DIR / "validation.jsonl"
TEST_FILE = DATASET_DIR / "test.jsonl"

RUN_ROOT = EXPERIMENT_ROOT / "38_random_1pct_seed_20260815"
...
def save_run_metadata(
    ...
    metadata = {
        "experiment": "tinyllama_qlora_main20k_random_1pct_seed_20260815",
