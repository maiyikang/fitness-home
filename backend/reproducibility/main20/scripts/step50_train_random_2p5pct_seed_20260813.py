...
TRAIN_FILE = EXPERIMENT_ROOT / "37_ultra_low_budget_random_multiseed" / "seed_20260813" / "train_random_2p5pct.jsonl"
VALIDATION_FILE = DATASET_DIR / "validation.jsonl"
TEST_FILE = DATASET_DIR / "test.jsonl"

RUN_ROOT = EXPERIMENT_ROOT / "38_random_2p5pct_seed_20260813"
...
def save_run_metadata(
    ...
    metadata = {
        "experiment": "tinyllama_qlora_main20k_random_2p5pct_seed_20260813",
