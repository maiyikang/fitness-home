...
TRAIN_FILE = EXPERIMENT_ROOT / "37_ultra_low_budget_random_multiseed" / "seed_20260813" / "train_random_1pct.jsonl"
VALIDATION_FILE = DATASET_DIR / "validation.jsonl"
TEST_FILE = DATASET_DIR / "test.jsonl"

RUN_ROOT = EXPERIMENT_ROOT / "38_random_1pct_seed_20260813"
FULL_RUN_DIR = RUN_ROOT / "full_run"
SMOKE_RUN_DIR = RUN_ROOT / "smoke_test"

EXPECTED_TRAIN_SAMPLES = 160
EXPECTED_VALIDATION_SAMPLES = 1948
EXPECTED_TEST_SAMPLES = 2069
EXPECTED_TOTAL_SAMPLES = 4177
# =====================================================================
# Utility functions
# =====================================================================
...
def save_run_metadata(
    ...
    metadata = {
        "experiment": "tinyllama_qlora_main20k_random_1pct_seed_20260813",
