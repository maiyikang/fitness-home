...
TRAIN_FILE = EXPERIMENT_ROOT / "31_rmegd_v2_low_budget_multiseed" / "seed_20260815" / "train_rmegd_5pct.jsonl"
VALIDATION_FILE = DATASET_DIR / "validation.jsonl"
TEST_FILE = DATASET_DIR / "test.jsonl"

RUN_ROOT = EXPERIMENT_ROOT / "32_rmegd_5pct_seed_20260815"
...
def save_run_metadata(
    ...
    metadata = {
        "experiment": "tinyllama_qlora_main20k_rmegd_v2_5pct_seed_20260815",
