...
TRAIN_FILE = EXPERIMENT_ROOT / "23_megd_v1_distillation_frozen" / "train_megd_50pct.jsonl"
VALIDATION_FILE = DATASET_DIR / "validation.jsonl"
TEST_FILE = DATASET_DIR / "test.jsonl"

RUN_ROOT = EXPERIMENT_ROOT / "24_main20k_qlora_megd_50pct"
...
def save_run_metadata(
    ...
    metadata = {
        "experiment": "tinyllama_qlora_main20k_megd_50pct",
